              ...
              {isLoadingProjects ? (
                ...
                <div className="space-y-4">
                  {projects.slice(0, 3).map((project) => (
                    <div key={project.id} className="border border-warm-100/20 rounded-md p-3 bg-warm-50/20 hover:bg-warm-50/40 transition-colors">
                      <div className="flex justify-between">
                        <h4 className="text-warm-300 font-medium">{project.name}</h4>
                        <span className={
